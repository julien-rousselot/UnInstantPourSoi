        ...
        <>
            ...
            <main>
                <section className='container-img-text right'>
                    ...
                    <div className='text-massage'><h4>Les epilations a la cire
                    </h4>
                    <p>Les epilations a la cire
                        Une épilation durable, une peau lisse et douce, les épilations se réalise avec une cire chaude traditionnelle. <br /><br />
                        Sourcils : 7€ <br />
                        Lèvres : 7€ <br />
                        Menton : 7€ <br />
                        Aisselles : 12€ <br />
                ...
                <img src={PhotoPrestationOngles} alt="dos Massage" />
                    ...
                    <p>Prendre soin de ses mains et de ses pieds, créer une forme d'ongle, repousser les cuticules, grâce à la manucure et/ou la beauté des pieds express. <br />
                        ...
                        Beauté des pieds complète : 45€<br />
                        Pose de vernis classique : 12€<br />
                        Pose de vernis semi permanent : 40€<br />
                        Pose de vernis semi permanent french : 45€<br />
                        Dépose et remise en forme de vernis semi permanent : 10€<br />
