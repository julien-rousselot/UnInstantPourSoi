        ...
        <>
            <header>
                <section className='header-accueil'>
                    ...
                    <div className='text-header-style'>
                        ...
                        <img className='ligne-header' src={courbe}/>
            ...
            <main>
                ...
                <section className='container-img-text right'>
                    ...
                    <p>Découvrez une sélection de gommage avec différentes textures, parfums et grains fins, modéré ou fort.
                ...
                <section className='container-img-text left'>
                    ...
                    <p>Offrez un instant de bien-être et de détente à vos proches.
                    Les cartes cadeau permettent d’offrir soit une somme de votre choix; une prestation de bien-être ou de beauté ou une durée pour prendre son rendez-vous.
